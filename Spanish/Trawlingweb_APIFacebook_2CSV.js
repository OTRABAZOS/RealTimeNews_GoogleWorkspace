 ...
 * Hace una llamada a un worker de Facebook configurado dentro de www.trawlingweb.com. Utiliza la id del worker
 ...
 * No mezclar con colecciones de otars redes sociales distintas a Facebook
 * Debes configurar las variables: var tsInicio = ahora.getTime() - (60*24);  // var urlBase = // var idCarpeta = // var nombreArchivo = //
 */
function llamarAPIYProcesarDatos() {
  // Calcula timestamps para definir el rango de fecha de la colección que obtendremos
  var ahora = new Date();
  ...
  var urlBase = `https://facebook.trawlingweb.com/posts/iiiiiiiiiiiiiiiii/?token=ttttttttttttttttttt&order=desc&ts=${tsInicio}&tsi=${tsFin}`;
  // Sustituye /iiiiiiiiiiiiiiiii por la id de tu worker de twitter en trawlingweb. Sustituye //ttttttttttttttttttt/ por tu token API Facebook de Trawlingweb. 
  ...
  var nombreArchivo = "facebook_miempresa_" + fechaHoy + ".csv"; // Sustitiye miempresa por le nombre que quieras
  var idCarpeta = 'ttttttttttttttttttt'; // Sustituye 'ccccccccccccccccc' por la ID de la carpeta donde se buscarán los CSVs
